...
def SendErrorMail(error):
    ...
    {error}
    '''
    mail.HTMLBody = '''<h2>Bij het uitvoeren van het script is een error vastgesteld.</h2>
    <h3>Hieronder vindt u een overzicht van de error</h3>'''  # this field is optional
    mail.display()
    mail.Send()
    outlook.Logoff()
